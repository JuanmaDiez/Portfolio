...
public class ErrorMessageUtils {
    ...
    public static final String NO_TECHNOLOGIES = "No technologies were found";
    public static final String TECHNOLOGY_NOT_FOUND = "No technology linked to the id provided was found";
    public static final String TECHNOLOGY_ALREADY_EXISTS = "The technology you are trying to create already exists";
    public static final String SERVER_ERROR = "There was an error with our server, please try again later";
    ...
    public static final String TECHNOLOGIES_PARSE_ERROR = "Technologies weren't received in the appropriate format. Please, send them as an array";
    ...
    public static final String BAD_CREDENTIALS = "Credentials received do not check out";
}
